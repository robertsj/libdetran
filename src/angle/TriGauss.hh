...
private:
  ...
  void build_impl(c_dbl a, c_dbl b)
  {
    ...
    {
      x[0] = 0.993717285709994;
      x[1] = 0.866596908713918;
      x[2] = 0.499008815360491;
      x[3] = 0.111919417802102;
      w[0] = 0.031231058615361;
      w[1] = 0.252672442055963;
      w[2] = 0.438800178399074;
      w[3] = 0.277296320929603;
    }
    else if (m == 5)
    {

...
#
# Modified 2013 Jeremy Roberts
# 
#   The macros and associated header now include macros for doing template
#   instantiations that appear to be needed by Visual Studio.  Consider the
#   the following (shortened from http://support.microsoft.com/kb/168958):
#
#   // MyClass.hh
#   class EXPORT_MACRO_NAME MyClass {
#     std::vector<int> int_data;
#   }
#   TEMPLATE_EXPORT_MACRO_NAME std::vector<int>
#   // then use elsewhere.
#
#   where EXPORT_MACRO_NAME and TEMPLATE_EXPORT_MACRO_NAME are used in 
#   the header template and account for export/import differences (i.e.
...
macro(_DO_SET_MACRO_VALUES TARGET_LIBRARY)
  ...
  set(DEFINE_EXPORT)
  set(DEFINE_IMPORT)
  set(DEFINE_INSTANTIATE_EXPORT "template class __VA_ARGS__;")
  set(DEFINE_INSTANTIATE_IMPORT "template class __VA_ARGS__;")
  ...
  if(NOT ${type} STREQUAL "STATIC_LIBRARY")
    if(WIN32)
      ...
      set(DEFINE_INSTANTIATE_EXPORT "       template class __declspec(dllexport) __VA_ARGS__;")
      set(DEFINE_INSTANTIATE_IMPORT "extern template class __declspec(dllimport) __VA_ARGS__;")
      set(DEFINE_TEMPLATE_EXPORT    "       template class __declspec(dllexport) __VA_ARGS__;")
      set(DEFINE_TEMPLATE_IMPORT    "extern template class __declspec(dllimport) __VA_ARGS__;")
    elseif(COMPILER_HAS_HIDDEN_VISIBILITY AND USE_COMPILER_HIDDEN_VISIBILITY)
      ...
      set(DEFINE_TEMPLATE_EXPORT    " ") # It appears "template class EXPORT std::vector<int>;"
      set(DEFINE_TEMPLATE_IMPORT    " ") # is *not* valid outside of visual studio.
    endif()
  endif()
endmacro()
...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  set(TEMPLATE_INSTANTIATE_MACRO_NAME "${_GEH_PREFIX_NAME}${BASE_NAME_UPPER}_INSTANTIATE_EXPORT")
  ...
  if(_GEH_TEMPLATE_EXPORT_MACRO_NAME)
    set(TEMPLATE_EXPORT_MACRO_NAME ${_GEH_PREFIX_NAME}${_GEH_EXPORT_MACRO_NAME})
  endif()
  ...
  configure_file("${_GENERATE_EXPORT_HEADER_MODULE_DIR}/exportheadermodifed.cmake.in"

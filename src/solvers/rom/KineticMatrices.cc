...
KineticMatrices::KineticMatrices(SP_input inp, SP_mesh mesh, SP_material mat, SP_matrix basis_f, SP_matrix basis_p)
:d_input(inp),
 d_mesh(mesh),
 d_mat(mat),
...
SP_matrix KineticMatrices::precursors_decay()
{
  // precursors decay
  SP_matrix P;
...
//----------------------------------------------------------------------------//
SP_matrix KineticMatrices::delayed_production()
{
  // The reduced
  SP_matrix D;
...
SP_matrix KineticMatrices::precursors_production()
{
  int m;

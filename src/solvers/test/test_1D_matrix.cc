...
int test_1D_matrix(int argc, char *argv[])
{
 ...
 // solve the steady state system
  ...
  // number of rows : 8*n + 2*n
  int * rows_L = d_D->rows(); // list of list
  int* cols_L = d_D->columns(); // list of the nonzeros elemetnts  length
  double* v_L = d_D->values(); //list of the nonzeros elemetnts  length

  int * rows_F = d_G->rows(); // list of list
  int* cols_F = d_G->columns(); // list of the nonzeros elemetnts  length
  double* v_F = d_G->values(); //list of the nonzeros elemetnts  length

...
#define TEST_LIST               \
        FUNC(test_1D_transient_diffusion)
...
int test_1D_transient_diffusion(int argc, char *argv[])
{
 ...
 Mesh1D::SP_mesh mesh = get_mesh(50);

 std::string flux_basis = "/home/rabab/opt/detran/source/src/solvers/test/1D_slab_transient_flux_basis";
 std::string precursors_basis = "/home/rabab/opt/detran/source/src/solvers/test/1D_slab_transient_precurses_basis";

 SP_matrix basis_f;
 basis_f = new callow::MatrixDense(700, 10);
 ROMBasis::GetBasis(flux_basis, basis_f);

 SP_matrix basis_p;
 basis_p = new callow::MatrixDense(2800, 5);
 ROMBasis::GetBasis(precursors_basis, basis_p);

 Kinetic_Mat K(inp, mesh, mat, basis_f, basis_p);

 SP_matrix mat1 ;
 mat1 = new callow::MatrixDense(10, 10);
 mat1 = K.Mat1();
 mat1->print_matlab("mat1.txt");

 SP_matrix mat2 ;
 mat2 = new callow::MatrixDense(10, 5);
 mat2 = K.Mat2();
 mat2->print_matlab("mat2.txt");

 SP_matrix mat3;
 mat3 = new callow::MatrixDense(5, 10);
 mat3 = K.Mat3();
 mat3->print_matlab("mat3.txt");
